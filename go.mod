...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.22.8 // Multipart upload manager for S3Vault
	github.com/aws/aws-sdk-go-v2/service/s3 v1.97.1 // S3 client for S3Vault
